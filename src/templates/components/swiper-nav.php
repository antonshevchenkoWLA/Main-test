...
<button class="swiper-btn-prev-<?php echo $prefix; ?> w-8 h-8 flex items-center justify-center hover:bg-gray-300 rounded">
    <svg width="25" height="21" viewBox="0 0 25 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M10.1253 18.8363L1.41418 10.1252M1.41418 10.1252L10.1253 1.41406M1.41418 10.1252L23.8142 10.1252" stroke="#071359" stroke-opacity="0.5" stroke-width="2" stroke-linecap="square"/>
    </svg>
